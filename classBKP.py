...
"Создание регулятора положения печатной пленки с необходимыми параметрами, выводим передаточную функцию регулятора"
...
"Создание регулятора натяжения печатной пленки с необходимыми параметрами, выводим передаточную функцию регулятора"
